...
useEffect(() => {
  ...
  console.log("storedUser from sessionStorage:", storedUser)
  ...
  if (storedUser && storedUser !== "undefined") {
    try {
      ...
      console.error("❌ Failed to parse JSON from sessionStorage:", err)
      setUserName("User")
    }
  } else {
    setUserName("User")
                  ...
                  <Card className="border-0 shadow-lg rounded-3xl bg-white">
                    <CardContent className="p-6">
                      ...
                      <div className="flex gap-3 mt-6">
                        <Button className="genz-gradient-1 text-white rounded-2xl">
              ...
              <Card className="border-0 shadow-lg rounded-3xl bg-gradient-to-br from-blue-50 to-purple-50">
                ...
                <CardContent>
                  <div className="mb-4">
                    ...
                    <Progress value={92} className="h-3 bg-neutral-200" />
                  </div>
