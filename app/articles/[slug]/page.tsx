  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 py-12">
      <div className="container px-4 md:px-6 max-w-4xl mx-auto">
        <Link href="/articles">
          <Button className="genz-gradient-1 text-white rounded-2xl px-6 py-3 mb-8">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back to Articles
          </Button>
        </Link>
        ...
        >
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl">
            <div className="mb-6">
              <p className="text-sm uppercase tracking-[0.24em] text-slate-500">{article.category}</p>
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div className="flex items-center gap-3">
                <img src={article.avatar} alt={article.author} className="h-12 w-12 rounded-full object-cover" />
                <div>
